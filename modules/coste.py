...
class Consulta(Listado):
   ...
   def output(self):
      print "Resumen:<br>"
      print "--------<br>"
      print '%d llamadas (%s minutos) con un coste de<font color="purple"> %.3f euros.</font><br>' % (self.num_llamadas(),self.duracion_total(),self.coste_voz)
      print '%d sms enviados con un coste de<font color="blue"> %.3f euros.</font><br>' % (self.num_sms(),self.coste_sms)
      print "%d mms enviados con un coste de %.3f euros.<br>" % (self.num_mms(),self.coste_mms)
      print 'Consumo total:<b><font color="red"> %.2f euros.</font></b><br>' % self.coste_total
      print "<br>"
      print "Estadistica de llamadas:<br>"
      print "------------------------<br>"
      print "<1  minuto    %3d <br>" % self.est_llamadas(0,1)
      print "1-2 minutos   %3d <br>" % self.est_llamadas(1,2)
      print "2-4 minutos   %3d <br>" % self.est_llamadas(2,4)
      print "4-5 minutos   %3d <br>" % self.est_llamadas(4,5)
      print ">5 minutos    %3d <br>" % self.est_llamadas(5,100000)
